defmodule VbtfriendsWeb.FilterLive do
  use VbtfriendsWeb, :live_view

  alias Vbtfriends.Boats
    ...
    <div id="filter">
      <form phx-change="filter">
        <div class="filters flex">
          <select name="type" class="mx-20 px-10">
            <%= options_for_select(type_options(), @type) %>
          </select>
          <div class="prices flex items-center mx-20">
      ...
      <div class="boats flex flex-wrap">
        <%= for boat <- @boats do %>
